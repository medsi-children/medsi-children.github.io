(function(){
  ...
  if(!document.querySelector('script[data-medsi-message-enhancements]')){
    const s=document.createElement('script');s.src='/chat-overlay/message-enhancements.js?v=20260906-receipts';s.dataset.medsiMessageEnhancements='1';document.head.appendChild(s);
  }
